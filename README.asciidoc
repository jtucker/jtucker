...
|====
// untappd beer
| image:https://api.untappd.com/v4/image/checkinphoto/1218330171?size=sm[An Age of Islands - Lost Generation] | Drinking a *An Age of Islands* by *Lost Generation*. It is a *IPA - New England / Hazy* style of beer. | I rated it a *3.8*
